...
messages!(
    ...
    (ListClaudeSessions, Background),
    (ListClaudeSessionsResponse, Background),
    (ListClaudeSubagents, Background),
    (ListClaudeSubagentsResponse, Background),
    (ListClaudeSubagentsForSessions, Background),
    (ListClaudeSubagentsForSessionsResponse, Background),
    (ListClaudeAgents, Background),
    (ListClaudeAgentsResponse, Background),
    ...
    (ReadClaudeFile, Background),
    (ReadClaudeFileResponse, Background),
    ...
    (TailClaudeEvents, Background),
    (TailClaudeEventsResponse, Background),
    (TailClaudeChannelInbox, Background),
    (TailClaudeChannelInboxResponse, Background),
    (ClaudeChannelStatus, Background),
    (ClaudeChannelStatusResponse, Background),
    (ClaudeChannelSend, Background),
    (ClaudeChannelSendResponse, Background),
    (ClaudeChannelAnswerPermission, Background),
    (ClaudeChannelAnswerPermissionResponse, Background),
    (ClaudeChannelInterrupt, Background),
    (ClaudeChannelInterruptResponse, Background),
    (ReadClaudeStatus, Background),
    (ReadClaudeStatusResponse, Background),
    (InstallClaudeHooks, Background),
    (InstallClaudeHooksResponse, Background),
    (UninstallClaudeHooks, Background),
    (UninstallClaudeHooksResponse, Background),
    (ClaudeHooksInstalled, Background),
    (ClaudeHooksInstalledResponse, Background),
    (ListClaudeSlashCommands, Background),
    (ListClaudeSlashCommandsResponse, Background),
    (ListClaudeSessionFiles, Background),
    (ListClaudeSessionFilesResponse, Background),
    (WriteClaudeSessionFile, Background),
    (WriteClaudeSessionFileResponse, Background),
    (ResumeClaudeSession, Background),
    (ResumeClaudeSessionResponse, Background),
    (RunClaudeAgentCommand, Background),
    (RunClaudeAgentCommandResponse, Background),
    ...
    (TailClaudeTranscript, Background),
    (TailClaudeTranscriptResponse, Background),
...
request_messages!(
    ...
    (ListClaudeSessions, ListClaudeSessionsResponse),
    (ListClaudeSubagents, ListClaudeSubagentsResponse),
    (
        ListClaudeSubagentsForSessions,
        ListClaudeSubagentsForSessionsResponse
    ),
    (ListClaudeAgents, ListClaudeAgentsResponse),
    (ResumeClaudeSession, ResumeClaudeSessionResponse),
    (RunClaudeAgentCommand, RunClaudeAgentCommandResponse),
    (TailClaudeTranscript, TailClaudeTranscriptResponse),
    (TailClaudeEvents, TailClaudeEventsResponse),
    (ReadClaudeStatus, ReadClaudeStatusResponse),
    (InstallClaudeHooks, InstallClaudeHooksResponse),
    (UninstallClaudeHooks, UninstallClaudeHooksResponse),
    (ClaudeHooksInstalled, ClaudeHooksInstalledResponse),
    (ReadClaudeFile, ReadClaudeFileResponse),
    (ListClaudeSlashCommands, ListClaudeSlashCommandsResponse),
    (ListClaudeSessionFiles, ListClaudeSessionFilesResponse),
    (WriteClaudeSessionFile, WriteClaudeSessionFileResponse),
    (ClaudeChannelStatus, ClaudeChannelStatusResponse),
    (ClaudeChannelSend, ClaudeChannelSendResponse),
    (
        ClaudeChannelAnswerPermission,
        ClaudeChannelAnswerPermissionResponse
    ),
    (ClaudeChannelInterrupt, ClaudeChannelInterruptResponse),
    (TailClaudeChannelInbox, TailClaudeChannelInboxResponse),
