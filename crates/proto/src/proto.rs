...
messages!(
    ...
    (CaptureClaudePane, Background),
    (CaptureClaudePaneResponse, Background),
    (GetClaudePendingQuestion, Background),
    (GetClaudePendingQuestionResponse, Background),
    (InstallClaudeQuestionHook, Background),
    (InstallClaudeQuestionHookResponse, Background),
...
request_messages!(
    ...
    (CaptureClaudePane, CaptureClaudePaneResponse),
    (GetClaudePendingQuestion, GetClaudePendingQuestionResponse),
    (InstallClaudeQuestionHook, InstallClaudeQuestionHookResponse),
